...
from amadeo_utils.ai.tts import kokoro
...
class TTSServer:
    ...
    def __init__(self, config_dict:Dict):
        ...
        self.kokoro_model = kokoro.AmadeoKokoro(config_dict)
        self.server = AmadeoServer(config_dict['host'], config_dict['port'], additional_client_functionality = self.kokoro_model.handle_client_request)


def main():

    arg_dict = kokoro.AmadeoKokoro.get_args_dict()
